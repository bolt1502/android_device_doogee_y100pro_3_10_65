...
$(call inherit-product-if-exists, vendor/y100pro/persimmon/persimmon-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/y100pro/persimmon/overlay
...
ifeq ($(TARGET_PREBUILT_KERNEL),)
    LOCAL_KERNEL := device/y100pro/persimmon/prebuilt/Image.gz-dtb
else
...
PRODUCT_COPY_FILES += \
    device/y100pro/persimmon/rootdir/init.rc:root/init.rc \
    device/y100pro/persimmon/rootdir/init.target.rc:root/init.target.rc \
    device/y100pro/persimmon/rootdir/init.mt6735.rc:root/init.mt6735.rc \
    device/y100pro/persimmon/rootdir/init.ssd.rc:root/init.ssd.rc \
    device/y100pro/persimmon/rootdir/init.xlog.rc:root/init.xlog.rc \
    device/y100pro/persimmon/rootdir/init.usb.rc:root/init.usb.rc \
    device/y100pro/persimmon/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
    device/y100pro/persimmon/rootdir/init.aee.rc:root/init.aee.rc \
    device/y100pro/persimmon/rootdir/init.project.rc:root/init.project.rc \
    device/y100pro/persimmon/rootdir/init.modem.rc:root/init.modem.rc \
    device/y100pro/persimmon/rootdir/init.trace.rc:root/init.trace.rc \
    device/y100pro/persimmon/rootdir/fstab.mt6735:root/fstab.mt6735 \
    device/y100pro/persimmon/rootdir/fstab.swap:root/fstab.swap \
    device/y100pro/persimmon/rootdir/ueventd.rc:root/ueventd.rc \
    device/y100pro/persimmon/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/y100pro/persimmon/etc/init/audioserver.rc:system/etc/init/audioserver.rc \
    device/y100pro/persimmon/etc/init/mediacodec.rc:system/etc/init/mediacodec.rc \
    device/y100pro/persimmon/etc/init/cameraserver.rc:system/etc/init/cameraserver.rc \
    device/y100pro/persimmon/etc/init/rild.rc:system/etc/init/rild.rc \
    device/y100pro/persimmon/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
    device/y100pro/persimmon/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
...
# BT A2DP
#PRODUCT_COPY_FILES += \
#    vendor/y100pro/persimmon/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
...
#PRODUCT_EXTRA_RECOVERY_KEYS += device/y100pro/persimmon/y100pro
...
#PRODUCT_MODEL := CyaniogenMod on Doogee persimmon
...
#persist.sys.y100pro.region=cn \
#persist.sys.y100pro.codepage=gbk \
#ro.y100pro.setupwizard.flyme=true \
#ro.y100pro.setupwizard.setlang=true \
#ro.y100pro.region.enable=true \
#ro.y100pro.contactmsg.auth=false \
#ro.y100pro.customize.pccw=false \
#ro.y100pro.autorecorder=true \
#ro.y100pro.visualvoicemail=true \
#ro.y100pro.security=false \
#ro.y100pro.permanentkey=false \
#ro.y100pro.sip.support=true \
#ro.y100pro.voip.support=false \
#sys.y100pro.m35x.white.config=false \
#sys.y100pro.white.config=false \
