...
$(call inherit-product-if-exists, vendor/doogee/y100pro/y100pro-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/doogee/y100pro/overlay
...
#TARGET_OTA_ASSERT_DEVICE := y100pro

TARGET_PROVIDES_INIT_RC := true

PRODUCT_COPY_FILES += \
    device/doogee/y100pro/rootdir/init.rc:root/init.rc \
    device/doogee/y100pro/rootdir/init.target.rc:root/init.target.rc \
    device/doogee/y100pro/rootdir/init.mt6735.rc:root/init.mt6735.rc \
    device/doogee/y100pro/rootdir/init.ssd.rc:root/init.ssd.rc \
    device/doogee/y100pro/rootdir/init.xlog.rc:root/init.xlog.rc \
    device/doogee/y100pro/rootdir/init.usb.rc:root/init.usb.rc \
    device/doogee/y100pro/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
    device/doogee/y100pro/rootdir/init.aee.rc:root/init.aee.rc \
    device/doogee/y100pro/rootdir/init.project.rc:root/init.project.rc \
    device/doogee/y100pro/rootdir/init.modem.rc:root/init.modem.rc \
    device/doogee/y100pro/rootdir/init.trace.rc:root/init.trace.rc \
    device/doogee/y100pro/rootdir/fstab.mt6735:root/fstab.mt6735 \
    device/doogee/y100pro/rootdir/fstab.swap:root/fstab.swap \
    device/doogee/y100pro/rootdir/ueventd.rc:root/ueventd.rc \
    device/doogee/y100pro/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/doogee/y100pro/etc/init/audioserver.rc:system/etc/init/audioserver.rc \
    device/doogee/y100pro/etc/init/mediacodec.rc:system/etc/init/mediacodec.rc \
    device/doogee/y100pro/etc/init/cameraserver.rc:system/etc/init/cameraserver.rc \
    device/doogee/y100pro/etc/init/rild.rc:system/etc/init/rild.rc \
    device/doogee/y100pro/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
    device/doogee/y100pro/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
...
# BT A2DP
#PRODUCT_COPY_FILES += \
#    vendor/doogee/y100pro/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
...
#PRODUCT_EXTRA_RECOVERY_KEYS += device/doogee/y100pro/doogee

#$(call inherit-product, $(SRC_TARGET_DIR)/product/core_64_bit.mk)
$(call inherit-product, $(SRC_TARGET_DIR)/product/full_base_telephony.mk)
#$(call inherit-product, build/target/product/aosp_arm64.mk)

#PRODUCT_NAME := cm_y100pro
#PRODUCT_DEVICE := y100pro
#PRODUCT_BRAND := CyaniogenMod
#PRODUCT_MODEL := CyaniogenMod on Doogee y100pro
...
#persist.sys.doogee.region=cn \
#persist.sys.doogee.codepage=gbk \
#ro.doogee.setupwizard.flyme=true \
#ro.doogee.setupwizard.setlang=true \
#ro.doogee.region.enable=true \
#ro.doogee.contactmsg.auth=false \
#ro.doogee.customize.pccw=false \
#ro.doogee.autorecorder=true \
#ro.doogee.visualvoicemail=true \
#ro.doogee.security=false \
#ro.doogee.permanentkey=false \
#ro.doogee.sip.support=true \
#ro.doogee.voip.support=false \
#sys.doogee.m35x.white.config=false \
#sys.doogee.white.config=false \
